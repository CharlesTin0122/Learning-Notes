...
右键点击蓝图图表来显示快捷菜单并搜索"子系统"，将出现类似于下图的内容。这里有每个主要类型的类目，以及每个特定子系统的单个条目。 ![](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/3c0a3483-8125-48cb-baa3-d740761bd2ed/subsystems_01.png)
