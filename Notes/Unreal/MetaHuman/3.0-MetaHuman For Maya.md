> 本篇记录插件三大工具（CharacterAssembler / ExpressionEditor / PoseEditor）的**交互式**用法。把这套 conform 流程脚本化的自研工具分析见 [6.0-MhRigCreator-从Mesh构建MetaHuman绑定](6.0-MhRigCreator-从Mesh构建MetaHuman绑定.md)。
