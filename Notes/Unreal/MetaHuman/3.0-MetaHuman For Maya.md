...
[Open: 8.0-MetaHuman For Maya-1763968355254.png](../../MAYA/Rigging/常用算法和问题/attachments/8ee26422baa7f155ae88c0e6560a4248_MD5.jpg)
![](../../MAYA/Rigging/常用算法和问题/attachments/8ee26422baa7f155ae88c0e6560a4248_MD5.jpg)
## CharacterAssembler角色组装器
- 用于载入整个角色
- [Open: 8.0-MetaHuman For Maya-1763969149987.png](../../MAYA/Rigging/常用算法和问题/attachments/f5854c8a1963eff98c679d1c11028ff0_MD5.jpg)
![](../../MAYA/Rigging/常用算法和问题/attachments/f5854c8a1963eff98c679d1c11028ff0_MD5.jpg)
- 选择导出的资产路径，选择要处理的角色，点击组装Assemble
- [Open: 8.0-MetaHuman For Maya-1763969781552.png](../../MAYA/Rigging/常用算法和问题/attachments/a8106e2033f7062bb4bbac48c7120d27_MD5.jpg)
![](../../MAYA/Rigging/常用算法和问题/attachments/a8106e2033f7062bb4bbac48c7120d27_MD5.jpg)
## ExpressionEditor（表情编辑器）
- 用于编辑表情效果
- [Open: 8.0-MetaHuman For Maya-1764056748413.png](../../MAYA/Rigging/常用算法和问题/attachments/ad697b9610803dba292f907f8d950bf3_MD5.jpg)
![|501x674](../../MAYA/Rigging/常用算法和问题/attachments/ad697b9610803dba292f907f8d950bf3_MD5.jpg)
### 中性姿势
- 用于修改模型绑定姿态时的顶点位置和骨骼位置
- [Open: 8.0-MetaHuman For Maya-1764057043941.png](../../MAYA/Rigging/常用算法和问题/attachments/7fbbb0722abd0d84f3897c49a28feeec_MD5.jpg)
![|468x631](../../MAYA/Rigging/常用算法和问题/attachments/7fbbb0722abd0d84f3897c49a28feeec_MD5.jpg)
- 右上角功能按钮依次为
	- 组装选中的LOD，一般为选择LOC0
	- 传递顶点位置，修改模型后点击
...
- 举例说明
	...
	- ![](../../MAYA/Rigging/常用算法和问题/attachments/c5db5c42685c709856754173e9332373_MD5.jpg)
	- 嘴巴与眼睛相似，但它有几个需要分组处理的关节，其定位虽然直观，但需要根据嘴唇肉质部分的体积进行目测。
	- ![|715x389](../../MAYA/Rigging/常用算法和问题/attachments/9d6df8fa4f10c31eb30a29275eda1162_MD5.jpg)
	- [Open: 8.0-MetaHuman For Maya-1764062772259.png](../../MAYA/Rigging/常用算法和问题/attachments/316b8e9a8b3f31feeeb188d83470fce4_MD5.jpg)
![|756x418](../../MAYA/Rigging/常用算法和问题/attachments/316b8e9a8b3f31feeeb188d83470fce4_MD5.jpg)
- 编辑骨骼位置脚本
```python
...
```
###  蒙皮权重
[Open: 8.0-MetaHuman For Maya-1764057751638.png](../../MAYA/Rigging/常用算法和问题/attachments/54b6d030d1cd0932433b481b13edccaf_MD5.jpg)
![](../../MAYA/Rigging/常用算法和问题/attachments/54b6d030d1cd0932433b481b13edccaf_MD5.jpg)
...
- 左侧四个按钮为：
	...
	- 开关顶点着色
### 表情姿势
[Open: 8.0-MetaHuman For Maya-1764058570203.png](../../MAYA/Rigging/常用算法和问题/attachments/abb2d1b317e2b63d0fff7e515d3b1619_MD5.jpg)
![](../../MAYA/Rigging/常用算法和问题/attachments/abb2d1b317e2b63d0fff7e515d3b1619_MD5.jpg)
...
- 当你点击编辑表情之后，会进入编辑模式
- [Open: 8.0-MetaHuman For Maya-1764061558655.png](../../MAYA/Rigging/常用算法和问题/attachments/ee828bd190f58c403c43d32c25efd9e9_MD5.jpg)
![|567x760](../../MAYA/Rigging/常用算法和问题/attachments/ee828bd190f58c403c43d32c25efd9e9_MD5.jpg)
- 右侧有一列功能按钮
- 前三个用于创建和移除预览表情模型
- 下三个用于镜像变形和骨骼
- 下两个用于反转选择
