...
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears.png)
- 批量脚本
```python 
...
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-1.png)
- 添加扭曲，仅需要末端控制器X轴旋转属性链接SplineIKHandle的Twist属性
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-2.png)
- 添加缩放
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-4.png)
- TODO：添加体积守恒
# 创建动态运动
- 创建dynamic控制器，跟FK控制器同理，并设为绿色
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-23.png)
- 复制尾巴IK曲线命名为tail_base_dyn_curve
- 选中该曲线执行
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-5.png)![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-6.png)
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-7.png)
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-9.png)
- 我们将两条曲线和毛囊移出层级，删除空组
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-12.png)
- 这时候曲线可以做动态模拟，但是两端被钉住
- 我们选择毛囊（follicle）找到他的shape节点属性PointLock改为base
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-14.png)
- 点击播放
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-15.png)
- 现在我们需要骨骼跟随这条模拟曲线，我们使用混合变形来实现
- 选中模拟曲线和IKSpline曲线，执行混合变形
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-16.png)
- 当我们将blendshape的值设为1时，IK曲线变形为模拟曲线
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-18.png)
# 链接属性
## Simulation属性

- 使用尾巴根控制器的Simulation属性链接曲线混合变形的权重属性
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-20.png)
...
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-21.png)
- 前两个和后两个控制点打簇，中间的每个点打簇
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-22.png)
- 现在我们将簇作为模拟控制器的子对象
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-24.png)
- 现在我们可以使用模拟控制器来控制模拟开始的初始Pose
- 链接根控制器FollowPose属性到毛发系统shape节点start curve attract属性（起始曲线吸附）
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-25.png)
- 切换工具栏到FX，点击交互式播放，这样我们在播放模拟动画时可以实时控制模拟对象
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-26.png)
- 这样当我们打开FollowPose属性为1，模拟会以tail_base_dyn_curve曲线状态为基础模拟。不会垂到下面去，而是跟随tail_base_dyn_curve曲线状态。
## Enable属性
- Enable属性时控制模拟的开关
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-27.png)
## 动态结算属性
- 链接动态结算参数属性
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-28.png)
- 其中Drag属性相当于阻尼
...
![](初级/attachments/33d3153b01c60d23c289d69c6cc5ea52_MD5.jpeg)
因此可以在总控制器添加一个Dynamic_Enable属性，用做全局的动态模拟开关
# 碰撞
- 可以使用一个代理模型进行碰撞，比如一个球
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-29.png)
- 选中这个球。执行
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-30.png)
- 选择当前驱动模拟的nucleus节点
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-31.png)
- 现在我们有了一个刚体
- 在需要碰撞的hairSystem节点属性中，启用碰撞
- ![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-32.png)![](初级/attachments/2.06-Dynamic%20Tail%20&%20Ears-33.png)
