...
- GimbalLock（万向锁）
	...
	- ![](attachments/01-Joints.png)
	- 在此情况下如果我们旋转Y轴，那么X轴也会跟着选择换。如果旋转Y轴时X轴和Z轴重合，那么我么就失去了Y轴的控制，这就是万向锁。
	- ![](attachments/01-Joints-1.png)
	- 要避免这样的情况出现，就要调整RotateOrder，将最不常用的旋转轴向放置在Y轴。我们无法完全避免万向锁，只能将其出现的程度最小化。 ![](attachments/01-Joints-2.png)
	- Python： 
```python 
...
## Unbind Skin
![](attachments/01-Joints%20&%20Skin-1.png)
