...
- ![](attachments/02-Connection%20&%20Constraint.png)
## NodeEditor
![](attachments/02-Connection%20&%20Constraint-1.png)
# Constraint
...
- ![](attachments/02-Connection%20&%20Constraint-3.png)
- 要解决这个问题，将世界向上类型设为ObjectUp，并将控制器作为对象，在角色绑定中可以使用头部控制器。
- ![](attachments/02-Connection%20&%20Constraint-4.png)
- 但是这样的话眼睛左右旋转超过一定角度 ，还是会发生偏转
- ![](attachments/02-Connection%20&%20Constraint-5.png)
- 所以要使用ObjectrotationUP 并指定对象和向上的轴
- ![](attachments/02-Connection%20&%20Constraint-6.png)