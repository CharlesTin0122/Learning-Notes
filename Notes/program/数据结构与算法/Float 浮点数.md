...
![](attachments/67d20b95e5df18c667fa1519b1616268_MD5.webp)
...
![](attachments/236884b723390d91c8f759b3df9fb309_MD5.webp)
...
![](attachments/d34d5b2810bcddfd8c8a8c94dabc1556_MD5.webp)
...
![](attachments/1a10e93dcbf8433bb24ace5b3dfeb1c2_MD5.webp)
...
所以 S = 0，尾数 M=1.1001001=1001001(去掉1，隐藏位)，指数 E = 4 + 127(中间数) = 131(D) = 1000 0011(B)。填充到 32 bit 中，如下：

![](attachments/4013792c58c170ea35329b08f395624d_MD5.webp)
...
以单精度浮点数 float 为例，它能表示的最大二进制数为 +$1.111111...1 * 2 ^{127}$（小数点后23个1），而二进制 1.11111...1 ≈ 2，所以 float 能表示的最大数为 $2^{128} = 3.4 * 10^{38}$，即 float 的表示范围为：$-3.4 * 10^{38} \rightarrow 3.4 * 10 ^{38}$。
